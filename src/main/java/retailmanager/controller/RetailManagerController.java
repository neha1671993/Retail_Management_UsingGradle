...
public class RetailManagerController {
	...
	public ResponseEntity get() {
		...
		shopAddress.setShopPlace("delhi");
	 ...
	 * Data Should be posted in this Format
{
  "shopAddress": {
    "shopNumber": 1,
    "shopPostCode": 1361118,
    "shopPlace": "kurukshetra"
  },
  "shopName": "HCL Shop"
}
 * @return
				...
				else
				{
					for (Map.Entry<String,List<ShopBean>> shopMap : RetailStoreMap.shopmap.entrySet()) {
						...
						for (ShopBean shop : shopMap.getValue()) {
							...
							if(shop.equals(shopBean))
							{
								String response = "Shop Details Already Present: \n"+shopBean;
								return new ResponseEntity(response, HttpStatus.OK);		
							}
							
							if (shopName.equals(shop.getShopName()) && !(shop.equals(shopBean))) {
								
								String response = "You Have Replaced the Shopname :"+shopName+" \nThe previous data was:"+shop;
								shops.add(shopBean);
